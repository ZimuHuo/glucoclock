...
@Route(value = "/doctor/patient-plots-view")
public class DoctorPlotView extends Div {
    ...
    public DoctorPlotView(UserService userService, PatientService patientService, LogService logService, SimpleLogBookService simpleLogBookService, ComprehensiveLogBookService comprehensiveLogBookService, IntensiveLogBookService intensiveLogBookService) {
        ...
        //get patient uid from session
        patientUid = (UUID) VaadinSession.getCurrent().getAttribute("PatientID");   //get patient uid
        title = new H3("Monthly Blood Glucose Report of "+VaadinSession.getCurrent().getAttribute("PatientName"));
